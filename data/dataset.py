...
class COCO(PairedDataset):
    def __init__(
        ...
        roots = {}
        roots['train'] = os.path.join(ann_root, 'captions_train2014_tokenized.json')
        roots['val'] = os.path.join(ann_root, 'captions_val2014_tokenized.json')
        roots['test'] = os.path.join(ann_root, 'captions_val2014_tokenized.json')
